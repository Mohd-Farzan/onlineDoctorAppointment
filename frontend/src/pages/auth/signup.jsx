...
import CommonForm from '@/Component/Common/form';// Assuming you have this in your config
      ...
      <div className="animate-on-mount transform translate-y-6 transition-all duration-700">
        ...
        {success && (
          <div className="success-animation absolute inset-0 bg-green-500/80 flex items-center justify-center rounded-xl z-10 opacity-0 pointer-events-none">
            ...
            <p className="mt-24 text-white font-semibold text-xl">Account created successfully!</p>
          </div>
        )}
        ...
        <div className="mt-8 bg-blue-50 rounded-lg p-4 border border-blue-100 animate-pulse-slow">
          <div className="flex">
            ...
            <p className="text-sm text-blue-700">
              Your data is securely encrypted. We'll never share your information with third parties.
            </p>
          </div>
        </div>
      </div>
